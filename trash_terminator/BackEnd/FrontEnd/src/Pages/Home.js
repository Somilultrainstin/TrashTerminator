      ...
      <Container>
        ...
        <Row className="d-flex justify-content-center">
          <div className="card col-lg-3 col-md-6 text-center">
            ...
            <p className={classes.servicePara}>
              Keep all your Dry Waste like Plastic, Paper and Metal segregated,
          ...
          <div className="card col-lg-3 col-md-6 text-center">
            ...
            <p className={classes.servicePara}>
              Contact us to schedule a pick up and we will collect the
          ...
          <div className="card col-lg-3 col-md-6 text-center">
            ...
            <p className={classes.servicePara}>
              We'll help you do your bit for the environment, by getting the
              waste recycled!
            </p>
          </div>
        </Row>
